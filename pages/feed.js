    ...
    <div style={{ background: '#f7f5f2', minHeight: '100vh', fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .feed-card { background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 4px 20px rgba(26,107,122,0.08); border: 1px solid rgba(26,107,122,0.06); margin-bottom: 24px; }
