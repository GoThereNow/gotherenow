    ...
    <div>
      ...
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .photo-wash { position: absolute; inset: 0; background: rgba(10,55,65,0.45); mix-blend-mode: multiply; }
        ...
        .photo-quote { font-family: 'Playfair Display', serif; font-size: 30px; font-weight: 300; color: #1a6b7a; line-height: 1.2; margin-bottom: 12px; }
        .photo-quote em { font-style: italic; }
        .photo-loc { font-size: 11px; letter-spacing: 2px; text-transform: uppercase; color: rgba(26,107,122,0.5); }
        .form-side { background: #f7f5f2; display: flex; align-items: center; justify-content: center; padding: 24px 48px; height: 100vh; overflow: hidden; }
        .form-inner { width: 100%; max-width: 380px; }
        .form-title { font-family: 'Playfair Display', serif; font-size: 36px; font-weight: 400; color: #1a6b7a; margin-bottom: 6px; }
        .form-sub { font-size: 14px; color: rgba(26,107,122,0.5); margin-bottom: 20px; }
        .role-toggle { display: grid; grid-template-columns: 1fr 1fr; gap: 2px; margin-bottom: 20px; background: rgba(26,107,122,0.06); border: 1px solid rgba(255,255,255,0.12); overflow: hidden; }
        .role-btn { padding: 11px; font-size: 13px; font-weight: 500; font-family: 'DM Sans', sans-serif; border: none; cursor: pointer; background: transparent; color: rgba(26,107,122,0.45); transition: all 0.2s; }
        ...
        .label { font-size: 11px; letter-spacing: 2px; text-transform: uppercase; color: rgba(26,107,122,0.5); }
        .input { background: rgba(26,107,122,0.06); border: 1px solid rgba(26,107,122,0.2); color: #1a6b7a; padding: 13px 16px; font-size: 14px; font-family: 'DM Sans', sans-serif; outline: none; transition: border-color 0.2s; }
        .input::placeholder { color: rgba(26,107,122,0.3); }
        .input:focus { border-color: rgba(26,107,122,0.5); background: rgba(26,107,122,0.08); }
        .field-hint { font-size: 11px; color: rgba(255,255,255,0.3); margin-top: 2px; }
        .btn { background: #b5654a; color: #1a6b7a; padding: 14px; font-size: 14px; font-weight: 700; font-family: 'Playfair Display', serif; border: none; cursor: pointer; transition: all 0.2s; margin-top: 4px; width: 100%; }
        .btn:hover { background: #a05540; }
        .btn:disabled { opacity: 0.6; cursor: not-allowed; }
        .divider { display: flex; align-items: center; gap: 16px; margin: 20px 0; }
        .divider::before, .divider::after { content: ''; flex: 1; height: 1px; background: rgba(26,107,122,0.08); }
        .divider span { font-size: 12px; color: rgba(26,107,122,0.3); }
        .switch { text-align: center; font-size: 13px; color: rgba(26,107,122,0.45); }
        .switch-link { color: #1a6b7a; font-weight: 600; text-decoration: none; border-bottom: 1px solid rgba(255,255,255,0.3); padding-bottom: 1px; }
        .switch-link:hover { border-color: #1a6b7a; }
        .success-icon { width: 56px; height: 56px; border-radius: 50%; background: rgba(255,255,255,0.15); display: flex; align-items: center; justify-content: center; font-size: 22px; color: #1a6b7a; margin: 0 auto 24px; }
